...
import { Clock, Mail, HelpCircle, Globe, LogIn } from "lucide-react";
    ...
    <header className="w-full bg-white border-b border-slate-200">
        ...
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-y-2">
          ...
          <div className="flex items-center gap-4 ml-auto">
            <div className="flex items-center gap-1.5 bg-red-600/90 text-white px-2.5 py-0.5 rounded font-medium text-xs">
              ...
              <span>{t("header.helplineLabel")} {t("header.helplineNumber")}</span>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col md:flex-row items-center justify-between gap-4">
        <Link to="/" className="flex items-center gap-4 text-center md:text-left">
          <div className="w-16 h-16 sm:w-18 sm:h-18 shrink-0 flex items-center justify-center bg-slate-50 border border-slate-200 rounded-full p-2">
            <img
