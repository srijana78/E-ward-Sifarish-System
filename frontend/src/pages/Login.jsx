      ...
      <div className="flex min-h-[calc(100vh-112px)] items-center justify-center">
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="overflow-hidden rounded-3xl bg-white shadow-xl shadow-slate-200/60">
            ...
            <div
              className={`px-6 pb-6 pt-7 text-center text-white ${
                isCitizen
                  ? "bg-indigo-600"
                  : "bg-green-900"
              }`}
            ...
            >
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="h-11 w-full rounded-xl bg-slate-50 pl-10 pr-4 text-sm outline-none ring-1 ring-slate-200 focus:bg-white focus:ring-2 focus:ring-slate-700"
                    />
              ...
              <div className="mb-5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-11 w-full rounded-xl bg-slate-50 pl-10 pr-11 text-sm outline-none ring-1 ring-slate-200 focus:bg-white focus:ring-2 focus:ring-indigo-500"
                  />
              ...
              <button
                type="submit"
                disabled={loading}
                className={`flex h-11 w-full items-center justify-center gap-2 rounded-xl text-sm font-semibold text-white transition disabled:opacity-60 ${
                  isCitizen
