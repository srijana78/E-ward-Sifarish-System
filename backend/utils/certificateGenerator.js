...
async function generateCertificate(application) {
  ...
  doc.fontSize(20).text("Ward Recommendation Certificate", {
    align: "center",
  });
  ...
  doc.text(
    `Applicant: ${application.applicantDetails.fullName}`
  );
  ...
  doc.text(
    "This certificate was issued through the E-Ward Sifarish digital verification system."
  );
  ...
  doc
    ...
    .fillColor("gray")
    .text(
      "Scan the QR code above to verify this certificate online."
    );
